...
const ox = `<canvas id="fullLayer" class="sketchpad fullLayer" width='480' height='600' style=''></canvas>`,
    ...
    <div class="canvas-container">\r
        ...
        <div id="post-sketchpad" class="post-sketchpad">\r
            <div id="submit">\r
                <button id='submitdrawing' class="button submitDrawing">Mittere</button><br/>\r
            </div>\r
...
const px = `<div id="controller" class="state-controller controller-content">
    ...
    gx = An.extend({
        defaults: {
            ...
            strings: {
                wait: "Sede et relaxa!",
                vip_waiting: "Exspectamus omnes lusores",
                vip_canStart: "Preme hoc signum, omnibus praesentibus",
                vip_cancel: "Preme hoc signum ludum inhibere ut initium non capiat.",
                vip_postgame: "Quid nunc facis?",
                vip_episodes_menu: "Episodiae Index",
                vip_episodes_unload: "Episodium exonera",
                vip_episodes_report: "Episodium Renuntia",
                vip_episodes_warning: "Attendite: usorum ingenia non sunt probata",
                vip_episodes_load: " Episodium per identificatorem:",
                vip_episodes_select: " Aut elige partem:",
                vip_episodes_back: "Redire",
                vip_episodes_submit: "SUBMITTERE",
                vip_episodes_view_author: "Inspectare auctorem",
                button_start: "Omnes sunt intus",
                button_cancel: "Cancellare",
                button_changename: "Mutare nomen",
                button_sameplayers: "Iidem ludificatores",
                button_newplayers: "Novi ludificatores",
                prompt_entername: "Scribe nomen tuum",
                prompt_choosecharacter: "Elige personam tuam",
                button_censorOptions: "Expurgare Optiones",
                censor_prompt: ""
            }
        }
    }),
